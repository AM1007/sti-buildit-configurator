    ...
    <div className="w-full max-w-sm mx-auto px-4 py-12 md:py-20">
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="register-email" className="block text-xs font-medium text-slate-700 mb-1.5">
              {t("auth.email")}
            </label>
          ...
          <div>
            <label htmlFor="register-password" className="block text-xs font-medium text-slate-700 mb-1.5">
              {t("auth.password")}
            </label>
            <div className="relative">
          ...
          <div>
            <label htmlFor="register-confirm" className="block text-xs font-medium text-slate-700 mb-1.5">
