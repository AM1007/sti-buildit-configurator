...
const MOUNTING_TO_COLOUR_LABEL: ConstraintMatrix = {
  ...
  C: ['CB', 'CE', 'CG', 'CR', 'CW', 'CY', 'ML', 'NB', 'NE', 'NG', 'NR', 'NW', 'NY'],
  D: ['CB', 'CE', 'CG', 'CR', 'CW', 'CY', 'EG', 'ML', 'NB', 'NG', 'NR', 'NW', 'NY'],
}
...
const SOUNDER_TO_COLOUR_LABEL: ConstraintMatrix = {
  ...
  '20': ['CB', 'CE', 'CG', 'CR', 'CW', 'CY', 'ML', 'NB', 'NE', 'NG', 'NR', 'NW', 'NY'],
  '30': ['CB', 'CG', 'CR', 'CY', 'EG', 'NB', 'NG', 'NR', 'NY'],
}
