  ...
  constraints: [
    {
      ...
      matrix: HOUSING_TO_BUTTONCOLOUR,
    },
    {
      sourceStep: 'buttonColour',
      targetStep: 'housingColour',
      matrix: BUTTONCOLOUR_TO_HOUSING,
    },

    {
      sourceStep: 'housingColour',
      targetStep: 'buttonType',
      matrix: HOUSING_TO_BUTTONTYPE,
    },
    {
      sourceStep: 'buttonType',
      targetStep: 'housingColour',
      matrix: BUTTONTYPE_TO_HOUSING,
    },
...

    {
      sourceStep: 'buttonColour',
      targetStep: 'buttonType',
      matrix: BUTTONCOLOUR_TO_BUTTONTYPE,
    },
    {
      sourceStep: 'buttonType',
      targetStep: 'buttonColour',
      matrix: BUTTONTYPE_TO_BUTTONCOLOUR,
    },
