...
const steps: Step[] = [
    ...
    options: [
      {
        ...
        label: '#13 Dome cover',
        code: '13',
        image: `${IMG}/COVER/13 Dome cover.webp`,
      },
      {
        id: '14',
...

  {
    ...
    options: [
      {
        id: '6',
        label: '#6 European Enclosed Back Box, 20mm Entry Point & Sealed Mounting Plate',
        code: '6',
        image: `${IMG}/MOUNTING/6 European Enclosed Back Box, 20mm Entry Point & Sealed Mounting Plate.webp`,
      },
      {
        id: '7',
        label: '#7 European Enclosed Back Box, 20mm Entry Point & Open Mounting Plate',
        code: '7',
        image: `${IMG}/MOUNTING/7 European Enclosed Back Box, 20mm Entry Point & Open Mounting Plate.webp`,
      },
    ],
  },
    ...
    options: [
      {
        ...
        code: '00',
        image: `${IMG}/HOOD_SOUNDER & WIRELESS/00 No Label Hood.webp`,
      },
      {
        id: '10',
