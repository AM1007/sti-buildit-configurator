...
const steps: Step[] = [
...

  {
    ...
    options: [
      ...
      {
        id: 'PO',
        label: '#PO EMERGENCY POWER OFF',
        code: 'PO',
        image: `${IMG}/TEXT/PO-EMERGENCY-POWER-OFF.webp`,
      },
      {
        id: 'ES',
        label: '#ES EMERGENCY STOP',
        code: 'ES',
        image: `${IMG}/TEXT/ES-EMERGENCY STOP.webp`,
      },
      {
        id: 'EV',
        label: '#EV EVACUATION',
      ...
      {
        id: 'HV',
        label: '#HV HVAC SHUT-DOWN',
        code: 'HV',
        image: `${IMG}/TEXT/HV-HVAC SHUT-DOWN.webp`,
      },
      {
        id: 'LD',
        label: '#LD LOCKDOWN',
...

  {
    ...
    options: [
      ...
      {
        id: 'ZL',
        label: '#ZL NON-RETURNABLE other language',
        code: 'ZL',
        image: `${IMG}/LANGUAGE/ZL-NON-RETURNABLE.webp`,
      },
    ],
  },
...
export const stopperStationsModel: ModelDefinition = {
  ...
  stepOrder: ['colour', 'cover', 'activation', 'text', 'language', 'installationOptions'],
