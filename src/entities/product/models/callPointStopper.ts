...
const steps: Step[] = [
  {
    ...
    options: [
      ...
      {
        id: '1',
        label: '#1 Surface mount (35mm)',
        code: '1',
        image: `${IMG}/MOUNTING/1 Surface mount (35mm).webp`,
      },
    ],
  },
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        label: '#PLAIN No text',
        code: 'PLAIN',
        image: `${IMG}/LABEL/plain no text.webp`,
      },
    ],
  },
]
...
export const callPointStopperModel: ModelDefinition = {
  ...
  stepOrder: ['mounting', 'colour', 'label'],

  productModelSchema: {
    baseCode: 'STI-693',
    partsOrder: ['mounting', 'colour', 'label'],
    separator: 'none',
    separatorMap: {
      mounting: '',
      colour: '-',
