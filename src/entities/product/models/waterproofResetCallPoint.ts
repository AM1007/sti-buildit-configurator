...

  {
    ...
    options: [
      ...
      // No SKU in 08_Waterproof_ReSet_Call_Point.md uses electrical code "01".
      {
        ...
        code: '02',
        image: `${IMG}/ELECTRICAL ARRANGEMENT/02-Single-Pole-Changeover.webp`,
      },
      {
        id: '11',
        label: '#11 Double Pole Changeover',
        code: '11',
        image: `${IMG}/ELECTRICAL ARRANGEMENT/11-Double-Pole-Changeover.webp`,
      },
    ],
  },
...
export const waterproofResetCallPointModel: ModelDefinition = {
  ...
  stepOrder: ['colour', 'electricalArrangement', 'label'],

  productModelSchema: {
    baseCode: 'WRP2',
    partsOrder: ['colour', 'electricalArrangement', 'label'],
    separator: 'dash',
    separatorMap: {
      colour: '-',
