    ...
    options: [
      {
        ...
        label: '#2 Switch Type',
        code: '2',
        image: `${IMG}/SWITCH TYPE/2-Switch-Type.webp`,
      },
      {
        id: '3',
        label: '#3 Switch Type',
        code: '3',
        image: `${IMG}/SWITCH TYPE/3-Switch-Type.webp`,
      },
      {
        id: '4',
        label: '#4 Switch Type',
        code: '4',
        image: `${IMG}/SWITCH TYPE/4-Switch-Type.webp`,
      },
      {
        id: '5',
        label: '#5 Switch Type',
        code: '5',
        image: `${IMG}/SWITCH TYPE/5-Switch-Type.webp`,
      },
    ],
  },
