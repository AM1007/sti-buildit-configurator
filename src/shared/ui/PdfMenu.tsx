...
import type { ProductModel, ModelId, Configuration, CustomTextData } from '@shared/types'
import { toast } from '@shared/utils/toast'
import { downloadProductPdf, printProductPdf } from '@shared/utils/generateProductPdf'
import { stripHtml } from '@shared/utils/stripHtml'
import { getModelSummary } from '@shared/utils/getModelSummary'
import { getHeroDescription } from '@shared/utils/getHeroDescription'
import { isIOSInAppBrowser } from '@shared/utils/detectWebView'
import { useTranslation, useLanguage } from '@shared/i18n'
import type { ProductPdfData } from '@shared/ui/ProductPdfDocument'
...
export function PdfMenu({
  ...
  const getPdfData = async (): Promise<ProductPdfData> => {
    ...
    const finalProductName =
      localizedProductName !== 'meta.name'
