    ...
    return (
      ...
      >
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-0.5">
          {code && (
            <span className={`font-mono leading-snug font-medium tracking-tight ${name ? "text-xs text-slate-400" : "text-[15px] text-slate-700"}`}>
              {code}
            </span>
          )}
          {name && (
  ...
  return (
    ...
    >
      ...
      <div className="flex h-[100px] flex-col gap-0.5 px-1.5 pt-3.5 pb-1.5">
        {code && (
          <span className={`font-mono leading-snug font-medium tracking-tighter ${name ? "text-xs text-slate-400" : "line-clamp-3 text-sm text-slate-700"}`}>
            {code}
          </span>
        )}
        {name && (
