...
export function ProjectPicker({
  ...
  const handleSelectProject = useCallback(async (project: Project) => {
    ...
    onSaved();
  }, [user, modelId, config, customText, model, savedProjectMap, addRemoteConfiguration, removeRemoteConfiguration, onSaved, savingTo, removingFrom]);
  ...
  }, [user, newName, createProject, addRemoteConfiguration, modelId, config, customText, model, onSaved]);
          ...
          {projects.length === 0 && !showNewForm ? (
            ...
            projects.map((project) => {
              ...
              return (
                ...
                >
                  <FolderOpen className={`h-4 w-4 shrink-0 ${isSaved ? "text-green-500" : "text-slate-400"}`} />
