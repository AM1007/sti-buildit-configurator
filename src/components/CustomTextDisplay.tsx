    ...
    <div>
      ...
      <div className="flex flex-col gap-3">
        <TextBlock
          ...
          lines={buildLines(customText.lineCount, customText.line1, customText.line2, customText.line3)}
          t={t}
        />
      ...
      <div className="flex flex-col gap-0.5 pl-5">
        {lines.map((line) => (
          <span key={line.num} className="text-[13px] text-slate-600 md:text-xs">
            <span className="text-slate-400">{t("customTextDisplay.line", { num: line.num })}:</span>{" "}
            {line.text}
          </span>
        ))}
      </div>
